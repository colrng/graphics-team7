...
Promise.all([
  faceapi.nets.faceRecognitionNet.loadFromUri('/labeled_images'),
    faceapi.nets.faceLandmark68Net.loadFromUri('/labeled_images'),
    faceapi.nets.ssdMobilenetv1.loadFromUri('/labeled_images')
]).then(start)
